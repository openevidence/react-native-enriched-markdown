...
void EnrichedMarkdownInputEventEmitter::onRequestCaretRectResult(OnRequestCaretRectResult event) const {
...
void EnrichedMarkdownInputEventEmitter::onCaretRectChange(OnCaretRectChange event) const {
...
void EnrichedMarkdownEventEmitter::onCitationPress(OnCitationPress event) const {
  dispatchEvent("citationPress", [event = std::move(event)](jsi::Runtime &runtime) {
    auto payload = jsi::Object(runtime);
    payload.setProperty(runtime, "numbers", event.numbers);
    return payload;
  });
}
...
void EnrichedMarkdownTextEventEmitter::onCitationPress(OnCitationPress event) const {
  dispatchEvent("citationPress", [event = std::move(event)](jsi::Runtime &runtime) {
    auto payload = jsi::Object(runtime);
    payload.setProperty(runtime, "numbers", event.numbers);
    return payload;
