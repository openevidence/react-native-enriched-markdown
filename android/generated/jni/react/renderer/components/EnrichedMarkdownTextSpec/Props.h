...
struct EnrichedMarkdownInputMarkdownStyleSpoilerStruct {
  SharedColor color{};
...
static inline std::string toString(const EnrichedMarkdownInputMarkdownStyleSpoilerStruct &value) {
  return "[Object EnrichedMarkdownInputMarkdownStyleSpoilerStruct]";
}

#ifdef RN_SERIALIZABLE_STATE
static inline folly::dynamic toDynamic(const EnrichedMarkdownInputMarkdownStyleSpoilerStruct &value) {
  return value.toDynamic();
}
#endif
...
struct EnrichedMarkdownMarkdownStyleSpoilerStruct {
  ...
  folly::dynamic toDynamic() const {
    folly::dynamic result = folly::dynamic::object();
    result["color"] = ::facebook::react::toDynamic(color);
    result["particleDensity"] = particleDensity;
    result["particleSpeed"] = particleSpeed;
    result["solidBorderRadius"] = solidBorderRadius;
    return result;
  }
#endif
};
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
  ...
  auto tmp_particleDensity = map.find("particleDensity");
  if (tmp_particleDensity != map.end()) {
    fromRawValue(context, tmp_particleDensity->second, result.particleDensity);
  }
  auto tmp_particleSpeed = map.find("particleSpeed");
  if (tmp_particleSpeed != map.end()) {
    fromRawValue(context, tmp_particleSpeed->second, result.particleSpeed);
  }
  auto tmp_solidBorderRadius = map.find("solidBorderRadius");
  if (tmp_solidBorderRadius != map.end()) {
    fromRawValue(context, tmp_solidBorderRadius->second, result.solidBorderRadius);
  }
}
...
struct EnrichedMarkdownMarkdownStyleCitationStruct {
  SharedColor backgroundColor{};
  SharedColor color{};
  Float fontSize{0.0};
  Float borderRadius{0.0};
...
static inline std::string toString(const EnrichedMarkdownMarkdownStyleCitationStruct &value) {
  return "[Object EnrichedMarkdownMarkdownStyleCitationStruct]";
}

#ifdef RN_SERIALIZABLE_STATE
static inline folly::dynamic toDynamic(const EnrichedMarkdownMarkdownStyleCitationStruct &value) {
  return value.toDynamic();
}
#endif
...
struct EnrichedMarkdownMarkdownStyleStruct {
  ...
  folly::dynamic toDynamic() const {
    ...
    result["spoiler"] = ::facebook::react::toDynamic(spoiler);
    result["citation"] = ::facebook::react::toDynamic(citation);
    return result;
  }
#endif
};
...
static inline void fromRawValue(const PropsParserContext &context, const RawValue &value,
  ...
  auto tmp_citation = map.find("citation");
  if (tmp_citation != map.end()) {
    fromRawValue(context, tmp_citation->second, result.citation);
  }
}
...
struct EnrichedMarkdownTextMarkdownStyleCitationStruct {
  SharedColor backgroundColor{};
  SharedColor color{};
  Float fontSize{0.0};
  Float borderRadius{0.0};
...
static inline std::string toString(const EnrichedMarkdownTextMarkdownStyleCitationStruct &value) {
  return "[Object EnrichedMarkdownTextMarkdownStyleCitationStruct]";
}

#ifdef RN_SERIALIZABLE_STATE
static inline folly::dynamic toDynamic(const EnrichedMarkdownTextMarkdownStyleCitationStruct &value) {
  return value.toDynamic();
}
#endif
