...
EnrichedMarkdownInputProps::EnrichedMarkdownInputProps(
...
folly::dynamic EnrichedMarkdownInputProps::getDiffProps(
    const Props* prevProps) const {
  static const auto defaultProps = EnrichedMarkdownInputProps();
  const EnrichedMarkdownInputProps* oldProps = prevProps == nullptr
      ? &defaultProps
      : static_cast<const EnrichedMarkdownInputProps*>(prevProps);
  if (this == oldProps) {
...
EnrichedMarkdownProps::EnrichedMarkdownProps(
    ...
    spoilerMode(convertRawProp(context, rawProps, "spoilerMode", sourceProps.spoilerMode, {std::string{"particles"}})),
    contextMenuItems(convertRawProp(context, rawProps, "contextMenuItems", sourceProps.contextMenuItems, {})) {}
